...
void App::OnLaunched(Windows::ApplicationModel::Activation::LaunchActivatedEventArgs^ pArgs)
{
	...
	ControlLogic = ref new Controller();
	ControlLogic->Initialize(Window::Current->CoreWindow, m_mainPage);

	m_eventToken = CompositionTarget::Rendering::add(ref new EventHandler<Object^>(this, &App::OnRendering));
}

/// <summary>
/// Call the Update and Render methods of the "Game" from here.
/// </summary>
void App::OnRendering( _In_ Object^ sender, _In_ Object^ args )
{
	ControlLogic->RunCycle();
}
